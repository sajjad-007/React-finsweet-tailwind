    ...
    <Div className='py-32 '>
        <Div className="w-container my-0 mx-auto">
            ...
            <Div className="cart_section mt-16">
                <Div className="cart_item hover:bg-primary  w-[406px] h-auto py-16 pr-[77px] pl-[48px] bg-pera rounded-xl flex flex-col transition-all ease-linear duration-300">
